...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  ...
	  typeMapping: __webpack_require__(165),
	  HigherOrderComponents: {
	    Boolean: __webpack_require__(173),
	    Focusable: __webpack_require__(174)
	  },
	  ...
	  defaultTheme: function defaultTheme(theme) {
	    ...
	    _componentsInputJs2["default"].originalClass.defaultProps.theme = theme;
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _higher_order_componentsErrors_normalizerJs = __webpack_require__(159);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _higher_order_componentJs = __webpack_require__(160);
	...
	var _default = (function (_React$Component) {
	  ...
	  _createClass(_default, [{
	    ...
	    value: {
	      ...
	      internalErrors: _react2["default"].PropTypes.oneOfType([_react2["default"].PropTypes.object, _react2["default"].PropTypes.array])
	    },
	    enumerable: true
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _delegates_public_functionsJs = __webpack_require__(161);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _validationsJs = __webpack_require__(163);
	...
	var Input = (function (_React$Component) {
	  ...
	  _createClass(Input, [{
	    ...
	    value: function _errors() {
	      ...
	      var errors = (this.props.errors || []).slice().concat(this.context.frigForm.errors[this.props.name] || []);
	      ...
	      if (validate) {
	        ...
	        try {
	          for (var _iterator = (0, _utilJs.entries)(this._validations())[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	            ...
	            errors = errors.concat(_validationsJs2["default"][k](opts) || []);
	          }
	        } catch (err) {
	          _didIteratorError = true;
	          _iteratorError = err;
	    ...
	    value: function _guessInputType() {
	      var jsType = typeof this._themedInputProps().valueLink.value;
	    ...
	    value: function _typeMapping() {
	      var typeMapping = Object.assign({}, __webpack_require__(165), this.context.frigForm.theme.type_mapping);
	    ...
	    value: function _themedComponent() {
	      ...
	      var component = this.context.frigForm.theme.component(type);
	  ...
	  var _Input = Input;
	  Input = (0, _higher_order_componentsErrors_normalizerJs2["default"])({
	    as: Array,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Submit = (function (_React$Component) {
	  ...
	  _createClass(Submit, [{
	    key: "render",
	    value: function render() {
	      var themedSubmit = this.context.frigForm.theme.component("submit");
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FormErrorList = (function (_React$Component) {
	  ...
	  _createClass(FormErrorList, [{
	    key: "render",
	    value: function render() {
	      var themedErrorList = this.context.frigForm.theme.component("errors");
	      return _react2["default"].createElement("themedErrorList", this.props);
	    }
	  }], [{
	    key: "contextTypes",
	    value: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _fieldset_nested_formJs = __webpack_require__(169);
	...
	var Fieldset = (function (_React$Component) {
	  ...
	  _createClass(Fieldset, [{
	    ...
	    value: function componentWillReceiveProps(nextProps, nextContext) {
	      ...
	      var numberOfForms = this._dataValues(nextContext).length;
	    ...
	    value: function modifications() {
	      ...
	      var isArray = Array.isArray(this.context.frigForm.data.value || []);
	    ...
	    key: "_listForKey",
	    value: function _listForKey(list, index) {
	    ...
	    value: function _onFormRequestChange(index, formData, valid) {
	    ...
	    value: function _dataValues() {
	      ...
	      var dataValues = nextContext.frigForm.data.value || [];
	    ...
	    value: function render() {
	      ...
	      var i = 0;
	      var nestedFormDatas = this._dataValues();
	      return _react2["default"].createElement(
	        "div",
	        null,
	        nestedFormDatas.map(function (data) {
	          return _react2["default"].createElement(_fieldset_nested_formJs2["default"], _this2._formProps({ data: data, index: i++ }));
	        })
	      );
	    }
	  }], [{
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _formJs = __webpack_require__(1);

	var _formJs2 = _interopRequireDefault(_formJs);

	// Nested forms (forms inside nested fieldsets)

	var FieldsetNestedForm = (function (_Form) {
	  _inherits(FieldsetNestedForm, _Form);
